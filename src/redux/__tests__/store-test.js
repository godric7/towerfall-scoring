...
const { reducer } = require("../store.js");

const { registerGame } = require("../actions.js");
...
describe("redux", () => {
  describe("reducer() REGISTER_GAME", () => {
    it("should register the new ratings", () => {
      ...
      expect(state.ratings).toEqual({ P1: 10000, P2: 10000 });
    });
    ...
    it("should merge new players", () => {
      ...
      expect(state2.games).toEqual([game1, game2]);
      expect(state2.ratings).toEqual({ P1: 10000, P2: 10000, P3: 10000 });
    });
    ...
    it("should update ratings based on ranking", () => {
      ...
      const state2 = reducer(state1, registerGame(game2));
      expect(state2.games).toEqual([game1, game2]);
      expect(state2.ratings).toEqual({ P1: 10600, P2: 9400 });
    });
  });
});
